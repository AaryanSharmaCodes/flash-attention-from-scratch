...
all: $(BUILD)/bench_sgemm $(BUILD)/bench_softmax $(BUILD)/bench_attention $(BUILD)/diagnose_sgemm $(BUILD)/test_reference
...
$(BUILD)/bench_attention: src/host/bench_attention.cu src/kernels/attention.cu src/kernels/sgemm.cu src/kernels/softmax.cu ref/reference.cpp | $(BUILD)
	$(NVCC) $(NVCCFLAGS) -o $@ $^
...
bench: $(BUILD)/bench_sgemm $(BUILD)/bench_softmax $(BUILD)/bench_attention
	...
	./$(BUILD)/bench_attention 1024
	./$(BUILD)/bench_attention 2048
	./$(BUILD)/bench_attention 4096
